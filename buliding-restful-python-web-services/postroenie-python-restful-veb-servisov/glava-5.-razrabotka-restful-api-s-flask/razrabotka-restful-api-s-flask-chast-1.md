...
В [главе 1](../glava-1.-razrabotka-restful-api-s-django/) «Разработка RESTful API с помощью Django» мы узнали, что в этой книге мы будем работать с облегченными виртуальными средами, представленными и улучшенными в Python 3.4. Теперь мы будем следовать инструкциям по созданию новой облегченной виртуальной среды для работы с Flask и Flask-RESTful. Настоятельно рекомендуется прочитать [главу 1](../glava-1.-razrabotka-restful-api-s-django/) «Разработка RESTful API с помощью Django», если у вас нет опыта работы с облегченными виртуальными средами на Python. Глава включает в себя все подробные объяснения результатов шагов, которым мы собираемся следовать.
